...
if errorlevel 1 (
    echo ERROR! You do not have the Java Runtime Environment installed, please install Java JRE from https://adoptium.net/?variant=openjdk21&package=jre and try again.
    goto EXIT
)
...
if %JAVA_MAJOR_VERSION% LSS 21 (
    echo ERROR! HiveMQ requires at least Java version 21.
    goto EXIT
)
...
rem Recovery
set "JAVA_OPTS=%JAVA_OPTS% -DstatefulCluster=true"
